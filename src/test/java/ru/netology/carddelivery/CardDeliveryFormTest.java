...
public class CardDeliveryFormTest {
    ...
    public void shouldCreditCardDeliveryOrder() {
        ...
        element.$("[data-test-id=city] input").setValue("Москва");
        ...
        element.$("[data-test-id=name] input").setValue("Иванова Дарья Викторовна");
        element.$("[data-test-id=phone] input").setValue("+79518232836");
